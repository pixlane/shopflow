...
const seedProducts: Product[] = [
  ...
  },
  {
    ...
    price: 145,
    images: ["https://images.unsplash.com/photo-1603189343302-e603f7add05a?w=800&q=80"],
  ...
  },
  {
    ...
    price: 195,
    comparePrice: 240,
    images: ["https://images.unsplash.com/photo-1588880331179-bc9b93a8cb5e?w=800&q=80"],
  ...
  },
  {
    ...
    price: 165,
    images: ["https://images.unsplash.com/photo-1600948836101-f9ffda59d250?w=800&q=80"],
  ...
  },
  {
    ...
    price: 55,
    images: ["https://images.unsplash.com/photo-1632759145351-1d592919f522?w=800&q=80"],
    category: seedCategories[3],
...
const seedOrders: Order[] = [
  {
    ...
    items: [
      { productId: "prod-1", productName: "Matte Ceramic Vase", sku: "CER-VAZ-001", price: 89, quantity: 2, image: "https://images.unsplash.com/photo-1565193566173-7a0ee3dbe261?w=200&q=80" },
      { productId: "prod-3", productName: "Walnut Serving Board", sku: "WOD-BRD-001", price: 195, quantity: 1, image: "https://images.unsplash.com/photo-1588880331179-bc9b93a8cb5e?w=200&q=80" },
    ],
  ...
  },
  {
    ...
    items: [
      { productId: "prod-2", productName: "Blown Glass Bowl", sku: "GLS-BWL-001", price: 145, quantity: 1, image: "https://images.unsplash.com/photo-1603189343302-e603f7add05a?w=200&q=80" },
    ],
  ...
  },
  {
    ...
    items: [
      { productId: "prod-4", productName: "Linen Throw Blanket", sku: "TEX-THR-001", price: 165, quantity: 2, image: "https://images.unsplash.com/photo-1600948836101-f9ffda59d250?w=200&q=80" },
      { productId: "prod-6", productName: "Oak Candle Holder Set", sku: "WOD-CND-001", price: 78, quantity: 1, image: "https://images.unsplash.com/photo-1576201836106-db1758fd1c97?w=200&q=80" },
    ],
  ...
  },
  {
    ...
    items: [
      { productId: "prod-7", productName: "Spun Glass Carafe", sku: "GLS-CAR-001", price: 112, quantity: 1, image: "https://images.unsplash.com/photo-1544967082-d9d25d867d66?w=200&q=80" },
    ],
  ...
  },
  {
    ...
    items: [
      { productId: "prod-5", productName: "Raku Tea Bowl", sku: "CER-TEA-001", price: 68, quantity: 3, image: "https://images.unsplash.com/photo-1612196808214-b8e1d6145a8c?w=200&q=80" },
      { productId: "prod-8", productName: "Woven Seagrass Tray", sku: "TEX-TRY-001", price: 55, quantity: 2, image: "https://images.unsplash.com/photo-1632759145351-1d592919f522?w=200&q=80" },
    ],
