...
const seedProducts: Product[] = [
  ...
  },
  {
    ...
    price: 145,
    images: ["https://images.unsplash.com/photo-1481437156560-3205f6a55735?w=800&q=80"],
...
const seedOrders: Order[] = [
  {
    ...
    items: [
      { productId: "prod-1", productName: "Matte Ceramic Vase", sku: "CER-VAZ-001", price: 89, quantity: 2, image: "https://images.unsplash.com/photo-1602173574767-37ac01994b2a?w=200&q=80" },
      { productId: "prod-3", productName: "Walnut Serving Board", sku: "WOD-BRD-001", price: 195, quantity: 1, image: "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=200&q=80" },
    ],
  ...
  },
  {
    ...
    items: [
      { productId: "prod-2", productName: "Blown Glass Bowl", sku: "GLS-BWL-001", price: 145, quantity: 1, image: "https://images.unsplash.com/photo-1481437156560-3205f6a55735?w=200&q=80" },
    ],
  ...
  },
  {
    ...
    items: [
      { productId: "prod-4", productName: "Linen Throw Blanket", sku: "TEX-THR-001", price: 165, quantity: 2, image: "https://images.unsplash.com/photo-1583847268964-b28dc8f51f92?w=200&q=80" },
      { productId: "prod-6", productName: "Oak Candle Holder Set", sku: "WOD-CND-001", price: 78, quantity: 1, image: "https://images.unsplash.com/photo-1602928321679-560bb453f190?w=200&q=80" },
    ],
  ...
  },
  {
    ...
    items: [
      { productId: "prod-7", productName: "Spun Glass Carafe", sku: "GLS-CAR-001", price: 112, quantity: 1, image: "https://images.unsplash.com/photo-1571115764595-644a1f56a55c?w=200&q=80" },
    ],
  ...
  },
  {
    ...
    items: [
      { productId: "prod-5", productName: "Raku Tea Bowl", sku: "CER-TEA-001", price: 68, quantity: 3, image: "https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?w=200&q=80" },
      { productId: "prod-8", productName: "Woven Seagrass Tray", sku: "TEX-TRY-001", price: 55, quantity: 2, image: "https://images.unsplash.com/photo-1586023492125-27b2c045efd7?w=200&q=80" },
    ],
